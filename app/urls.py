...
urlpatterns = [
    ...
    path('courses/<str:course>/<str:announce>/modify_announce', views.course_modify_announce, name='course_modify_announce'),
    ...
    path('courses/<str:course>/<str:announce>/man_grade/<str:file>', views.get_all_sub_view, name='manual_viewer'),             #vinayaka
    path('courses/<str:course>/<str:announce>/man_grade/<str:file>/list', views.get_user_sub_file_all, name='man_sub_list'),    #vinayaka
    path('courses/<str:course>/<str:announce>/man_grade/<str:file>/user/<str:name>', views.get_user_sub_file,                   #vinayaka
         name='user_sub_view'),
    ...
    path('courses/<str:course>/<str:announce>/auto_grade/get_csv', views.get_auto_csv, name='auto_get_csv'),                    #jishnu
    path('courses/<str:course>/<str:announce>/auto_grade/run_auto',views.run_auto_grade, name='run_auto_grade'),                #jishnu
    path('courses/<str:course>/<str:announce>/auto_grade/rerun_auto',views.rerun_auto_grade, name='rerun_auto_grade'),          #jishnu
    path('courses/<str:course>/<str:announce>/auto_grade/get_count',views.get_auto_count),

    # testing
#    path('testing/<str:course>/<str:announce>/<str:file>', views.temp, name='manual_viewer').
]
